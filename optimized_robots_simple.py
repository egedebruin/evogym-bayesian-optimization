...
for inherit in [(-1, 'none', 0), (1, 'parent', 1)]:
    for repetition in range(1, 21):
        config.FOLDER = f'results/learn-50_inherit-{inherit[0]}_type-{inherit[1]}_pool-{inherit[2]}_environment-simple_method-ddpg_vision-2_repetition-{repetition}/'
...
with open("results/simple-delta-results.pkl", "wb") as f:
